    ...
    return (
        <ResponsiveContainer width="100%" height={300}>
            <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 10 }}>
                ...
                <ReferenceLine x={12} stroke="var(--color-border)" strokeOpacity={0.5} strokeDasharray="5 5" />
                <ReferenceLine y={50} stroke="var(--color-border)" strokeOpacity={0.5} strokeDasharray="5 5" />
