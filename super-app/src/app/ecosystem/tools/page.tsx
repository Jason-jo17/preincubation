...
const TOOLS = [
  {
    ...
    status: "Active",
    impact: "High",
    href: "/ecosystem/tools/empathy_map"
  },
  {
    ...
    status: "Active",
    impact: "Very High",
    href: "/ecosystem/tools/stakeholder_mapping"
  },
  {
  ...
  },
  {
    ...
    status: "Active",
    impact: "Medium",
    href: "/ecosystem/tools/mtp_canvas"
  },
  {
    ...
    status: "Active",
    impact: "High",
    href: "/ecosystem/tools/fishbone_diagram"
  },
  {
    ...
    status: "Beta",
    impact: "Very High",
    href: "/ecosystem/tools/innovation"
  },
  {
    ...
    status: "Priority",
    impact: "Strategic",
    href: "/ecosystem/tools/venture_readiness"
  },
  {
  ...
  },
  {
    ...
    status: "Active",
    impact: "Very High",
    href: "/ecosystem/tools/lean_canvas"
  },
  {
  ...
  },
  {
    ...
    status: "Active",
    impact: "Impact",
    href: "/ecosystem/tools/theory_of_change"
  },
  {
    title: "FMEA Risk Matrix",
    description: "Analyze Failure Modes and Effects to prioritize risk mitigation based on RPN scores.",
    icon: Activity,
    status: "New",
    impact: "Safety",
    href: "/ecosystem/tools/fmea"
  },
  {
    title: "AARRR Pirate Funnel",
    description: "Track Acquisition, Activation, Retention, Referral, and Revenue for growth optimization.",
    icon: Rocket,
    status: "New",
    impact: "Growth",
    href: "/ecosystem/tools/aarrr"
  },
  {
    title: "Sean Ellis PMF Test",
    description: "Quantify Product-Market Fit using the 40% threshold methodology and qualitative feedback.",
    icon: Target,
    status: "New",
    impact: "Strategic",
    href: "/ecosystem/tools/sean_ellis"
  }
];
