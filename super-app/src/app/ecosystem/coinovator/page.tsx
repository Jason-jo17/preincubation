      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
           <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                { name: "TRL Tracker", icon: Rocket, color: "text-accent", desc: "Readiness Levels", href: "/ecosystem/sprint" },
                { name: "Roadmap", icon: Calendar, color: "text-indigo-500", desc: "Milestone Sync", href: "/ecosystem/sprint" },
                { name: "Compliance", icon: ShieldCheck, color: "text-emerald-500", desc: "Risk Audit", href: "/ecosystem/coinovator" },
                { name: "Experiments", icon: Activity, color: "text-orange-500", desc: "Validation Hub", href: "/ecosystem/coinovator" },
                { name: "Resources", icon: Users, color: "text-blue-500", desc: "Expert Lattice", href: "/ecosystem" },
