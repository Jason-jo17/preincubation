    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-border pb-8">
        <div className="space-y-4">
           <Link href="/stakeholders/sprint" className="group flex items-center gap-2 text-text-muted hover:text-accent transition-colors">
            ...
            <Card className="bg-bg-surface border-border rounded-[2.5rem] overflow-hidden shadow-xl">
               ...
               <CardContent className="p-0">
                  <div className="divide-y divide-border">
                     {TOOLS.map((tool, i) => {
                       const hrefs = {
                         "T1": "/stakeholders/problems",
                         "T2": "/stakeholders/solutions",
                         "T3": "/stakeholders",
                         "T4": "/intel"
                       };
                       return (
