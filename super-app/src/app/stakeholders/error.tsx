...
export default function StakeholderError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <h2 className="text-2xl font-black uppercase tracking-tight mb-2">Protocol <span className="text-accent">Interrupted</span></h2>
      <p className="text-text-muted max-w-sm mb-8 text-sm leading-relaxed">
        An error occurred while accessing the stakeholder oversight portal. Secure access may need to be re-initialized.
      </p>
