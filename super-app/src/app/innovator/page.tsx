            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <Card className="bg-bg-surface border-border shadow-sm rounded-[2.5rem] overflow-hidden">
                  ...
                  <CardContent className="p-8 space-y-6">
                     ...
                     <Button variant="outline" className="w-full h-12 rounded-xl font-black uppercase italic text-[10px] tracking-widest" asChild>
                        <Link href="/innovator/roadmap">Enter Strategic Map <ArrowUpRight className="w-3.5 h-3.5 ml-1" /></Link>
                     </Button>
                  </CardContent>
               </Card>
               ...
               <Card className="bg-bg-surface border-border shadow-sm rounded-[2.5rem] overflow-hidden">
                  ...
                  <CardContent className="p-8 space-y-6">
                     ...
                     <Button variant="outline" className="w-full h-12 rounded-xl font-black uppercase italic text-[10px] tracking-widest" asChild>
                        <Link href="/innovator/interactions">View Full Lattice <ArrowUpRight className="w-3.5 h-3.5 ml-1" /></Link>
                     </Button>
                  </CardContent>
               </Card>
            </div>
