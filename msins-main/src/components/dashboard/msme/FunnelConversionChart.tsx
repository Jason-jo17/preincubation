...
export function FunnelConversionChart({ data }: FunnelConversionChartProps) {
    ...
    const chartData = [
        { name: "Stage 1\nUploaded", value: data.stage_1_uploaded, color: "hsl(var(--primary))" },
        { name: "Stage 2\nScored", value: data.stage_2_scored, color: "hsl(var(--primary))" },
        { name: "Stage 3\nFinancials", value: data.stage_3_financials, color: "hsl(var(--primary))" },
        { name: "Stage 4\nRAG", value: data.stage_4_rag_classified, color: "hsl(var(--primary))" },
        { name: "Stage 5\nGap", value: data.stage_5_gap_analyzed, color: "hsl(var(--primary))" },
        { name: "Stage 6\nRoadmap", value: data.stage_6_roadmap_generated, color: "hsl(var(--success))" },
    ];
