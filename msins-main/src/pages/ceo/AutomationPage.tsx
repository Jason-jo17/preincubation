...
import { AutomationNeedCard } from '@/components/automation/AutomationNeedCard';
import { DEMO_AUTOMATION_NEEDS } from '@/data/automation-needs';
...
export default function AutomationPage() {
  ...
  const [needs, setNeeds] = useState<SectorAutomationNeed[]>(DEMO_AUTOMATION_NEEDS);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
         ...
         <div className="space-y-6">
            ...
            <ContentCard 
              ...
              description="Alignment with market drivers"
