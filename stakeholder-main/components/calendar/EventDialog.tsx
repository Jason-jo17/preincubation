...
import { useCalendarEvents, useStakeholders } from "@/lib/hooks/use-calendar"
...
export function EventDialog({ open, onOpenChange, event, initialDate }: EventDialogProps) {
    ...
    // Convert extendedProps if necessary or extract from top level
    ...
    const onSubmit = async (data: CalendarEventInput) => {
        try {
            if (event?.id) {
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <DialogFooter className="flex justify-between items-center sm:justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button type="submit">
                                    {event?.id ? 'Update Event' : 'Schedule Interview'}
                                </Button>
                            </div>
                        </DialogFooter>
                    </form>
