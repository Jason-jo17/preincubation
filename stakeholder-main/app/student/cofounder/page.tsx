...
import { TRLEventRecommendations } from "@/components/student/TRLEventRecommendations"
      ...
      <div className="grid gap-4 md:grid-cols-7">
        <div className="col-span-4 space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link href="/student/cofounder/crl-irl" className="block">
              <Card className="hover:bg-muted/50 transition-colors cursor-pointer h-full border-primary/20 bg-primary/5">
                <CardContent className="flex flex-col items-center justify-center p-6 text-center space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">CRL & IRL Assessment</p>
                </CardContent>
              </Card>
            </Link>
          </div>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-black uppercase tracking-widest text-muted-foreground italic flex items-center gap-2">
                ...
                TRL Stage Focus Events
              </CardTitle>
            </CardHeader>
            <CardContent>
              <TRLEventRecommendations />
            </CardContent>
          </Card>
        </div>
      </div>
