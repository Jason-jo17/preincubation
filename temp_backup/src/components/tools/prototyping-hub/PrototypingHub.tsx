...
import { ProjectDashboard } from '@/components/tools/prototyping-hub/ProjectDashboard'
import { ProjectDetails } from '@/components/tools/prototyping-hub/ProjectDetails'
