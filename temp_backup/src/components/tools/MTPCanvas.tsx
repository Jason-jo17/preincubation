...
export function MTPCanvas({ tool, progress, onDataSaved, isNewIteration, submissionId }: MTPCanvasProps) {
    const initialData = progress?.submittedData || progress?.data || {
        love: "",
        goodAt: "",
        needs: "",
        paidFor: "",
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2 max-w-sm">
                <Label className="text-primary font-bold uppercase text-xs">Entry Name / Iteration Title</Label>
                <Input
                    placeholder="e.g. Project A - MTP"
                    value={iterationName}
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
                ...
                <Button onClick={() => handleSave(false)} disabled={saving} className="w-full md:w-auto">
