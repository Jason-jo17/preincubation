        ...
        <Card className="relative overflow-hidden border-l-4 border-l-primary/50">
            <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                    ...
                    <Badge variant="outline" className={cn("capitalize border-0", priorityColors[milestone.priority as keyof typeof priorityColors])}>
                        {milestone.priority}
                    </Badge>
                </div>
            </CardHeader>
                ...
                {milestone.success_metrics && milestone.success_metrics.length > 0 && (
                    <div className="mt-3 pt-3 border-t">
                        ...
                        <ul className="space-y-1">
                            {milestone.success_metrics?.map((metric: string, i: number) => (
