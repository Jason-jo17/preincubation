            ...
            {!analysis ? (
                ...
                <>
                    <div className="grid gap-6 lg:grid-cols-2">
                        <GapRadarChart analysis={analysis as any} />
                        <GapSummary analysis={analysis as any} />
                    </div>

                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold">Vertical Deep Dive</h3>
                        <GapVerticalCards analysis={analysis as any} />
                    </div>

                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold">Strategic Recommendations</h3>
                        <GapRecommendations analysis={analysis as any} />
                    </div>
                </>
            )}
        </div>
